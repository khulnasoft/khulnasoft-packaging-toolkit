...
class PackagingRule(with_metaclass(AbstractMetaClass, object)):
    ...
    @abstractmethod
    def should_include_setting(
        self, stanza, setting, deployment_specification, app_manifest
    ):
        pass

    @abstractmethod
    def should_include_stanza(
        self, stanza, settings, deployment_specification, app_manifest
    ):
        pass
...
class InputsPackagingRule(DefaultPackagingRule):
    def should_include_setting(
        ...
        return self._should_include_stanza(
            stanza, deployment_specification, app_manifest
        )
