...
def main(args):
    ...
    if args.unset is not None:
        ...
        if len(undefined_names) > 0:
            SlimLogger.warning(
                "cannot unset undefined option names: ", encode_series(undefined_names)
            )
    ...
    if args.set is not None:
        ...
        if len(undefined_names) > 0:
            SlimLogger.warning(
                "cannot set undefined option names: ", encode_series(undefined_names)
            )
    ...
    if args.get is not None:
        ...
        options, undefined_names = slim_configuration.get(
            args.get, location, validate=True
        )

        if len(undefined_names) > 0:
            SlimLogger.warning(
                "cannot get undefined option names: ", encode_series(undefined_names)
            )
