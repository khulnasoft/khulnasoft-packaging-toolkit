# Version 20170103
#
# ** FOR USE IN KHULNASOFT LIGHT ONLY
#
# This file contains the settings and keywords available for the Khulnasoft Livetail feature.
...
#
# There is a default livetail.conf in $KHULNASOFT_HOME/etc/system/default that is
...
* All the settings below will be set via Khulnasoft UI.
