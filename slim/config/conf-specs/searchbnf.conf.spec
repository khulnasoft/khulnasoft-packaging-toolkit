...
#
# There is a searchbnf.conf in $KHULNASOFT_HOME/etc/system/default/.  It should
...
* Alternative names for the search command.  This further cleans
  ...
  'savedsearch' can also be called by 'macro' or 'savedkhulnasoft'.
...
#******************************************************************************
# Optional attributes primarily used internally at Khulnasoft
#******************************************************************************
