...
#
# There is no tags.conf in $KHULNASOFT_HOME/etc/system/default/.  To set custom
# configurations, place a tags.conf in $KHULNASOFT_HOME/etc/system/local/. For
# help, see tags.conf.example.  You must restart Khulnasoft to enable
# configurations.
#
