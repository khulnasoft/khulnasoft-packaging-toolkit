...
# can be configured on a per-user basis for use by the Khulnasoft Web UI.
...
# updated in
# $KHULNASOFT_HOME/etc/users/<username>/user-prefs/local/user-prefs.conf where
