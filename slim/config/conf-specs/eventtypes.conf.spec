...
# $KHULNASOFT_HOME/etc/system/local/eventtypes.conf.
#
# There is an eventtypes.conf in $KHULNASOFT_HOME/etc/system/default/.  To set
# custom configurations, place an eventtypes.conf in
# $KHULNASOFT_HOME/etc/system/local/. For examples, see eventtypes.conf.example.
