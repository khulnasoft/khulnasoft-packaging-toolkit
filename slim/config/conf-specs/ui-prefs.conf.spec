...
# view.
#
# There is a default ui-prefs.conf in $KHULNASOFT_HOME/etc/system/default. To set
# custom configurations, place a ui-prefs.conf in
# $KHULNASOFT_HOME/etc/system/local/. To set custom configuration for an app, place
# ui-prefs.conf in $KHULNASOFT_HOME/etc/apps/<app_name>/local/.  For examples, see
# ui-prefs.conf.example. You must restart Khulnasoft to enable configurations.
#
