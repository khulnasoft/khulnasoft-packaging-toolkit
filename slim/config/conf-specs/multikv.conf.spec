...
# multikv.conf in $KHULNASOFT_HOME/etc/system/local/. For examples, see
# multikv.conf.example.  You must restart Khulnasoft to enable configurations.
#
...
#
# NOTE: Only configure multikv.conf if Khulnasoft's default multikv behavior does
# not meet your needs.
