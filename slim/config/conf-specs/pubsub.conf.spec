...
# For examples, see pubsub.conf.example. You must restart Khulnasoft to enable
# configurations.
#
...
#******************************************************************
# The following section is only relevant to Khulnasoft developers.
#******************************************************************
...
* It is possible for any Khulnasoft to be a broker. If you have multiple brokers,
