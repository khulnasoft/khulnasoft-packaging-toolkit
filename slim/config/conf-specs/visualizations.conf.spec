...
# should include a visualizations.conf in $KHULNASOFT_HOME/etc/apps/<appname>/default
#
...
* If set to true, the visualization is not available anywhere in Khulnasoft
* Defaults to false.
