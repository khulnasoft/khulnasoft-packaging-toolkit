...
#
# There is a sourcetypes.conf in $KHULNASOFT_HOME/etc/system/default/ To set custom
# configurations, place a sourcetypes..conf in $KHULNASOFT_HOME/etc/system/local/.
# For examples, see sourcetypes.conf.example. You must restart Khulnasoft to enable
# configurations.
#
